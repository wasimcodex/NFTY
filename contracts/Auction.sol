...
contract NFTAuction {
    ...
    {
        return (nftContractAuctions[_nftContractAddress][_tokenId]
            .nftHighestBid >= nftContractAuctions[_nftContractAddress][_tokenId]
            .minPrice);
    }
        ...
        returns (bool)
    {
     ...
     function _doesBidMeetBidRequirements(
        ...
        if (
            buyNowPrice > 0 && msg.value >= buyNowPrice
        ) {
            return true;
        }
        //if the NFT is up for auction, the bid needs to be a % higher than the previous bid
        uint128 highestBid = nftContractAuctions[_nftContractAddress][_tokenId]
            .nftHighestBid;
        return (msg.value >= highestBid);
    }
        ...
        minPriceDoesNotExceedLimit(_buyNowPrice, _minPrice)
    {
        ...
        nftContractAuctions[_nftContractAddress][_tokenId].nftSeller = msg
            .sender;
        nftContractAuctions[_nftContractAddress][_tokenId].auctionEndTimestamp =
        ...
        internal
    {
        ...
        nftContractAuctions[_nftContractAddress][_tokenId].auctionEndTimestamp = 0;
